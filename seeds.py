...
# insert posts
# add_all() method again after users, because Post model requires valid user_id fields
# We need to run db.commit() again to confirm these latest insertions in the database.
db.add_all([
